...
def _create_profile_cache(ssg_root):
    ...
    product_list = ['debian9', 'debian10', 'debian11', 'fedora', 'ol7', 'opensuse',
                    'rhel7', 'sle12', 'sle15', 'slm5', 'ubuntu1604', 'ubuntu1804', 'ubuntu2004',
                    'wrlinux']
...
def find_profiles(ssg_root, path, obj_name):
    ...
    uses_sles_like_distro = 'opensuse' in used_products or 'sle12' in used_products or 'slm5' in used_products
